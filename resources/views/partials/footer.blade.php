<footer>
    <div class="bg">
        <div class="container">
            ...
            <p>All Site Content TM and <i class="fa-regular fa-copyright"></i> 2020 DC Entertainment, unless
                oterwise <a href="#">noted here</a>. All rights reserved. <br><a href="#">Cokies
                    Settings</a></p>
        </div>
    </div>
    <div id="copyright" class="container">
        ...
        <div class="follow">
            <ul>
                ...
                <li><img src="{{ Vite::asset('resources/img/footer-periscope.pn') }}" alt=""></li>
            </ul>
        </div>
    </div>
</footer>
